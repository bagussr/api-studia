...
Revision ID: 16f8f68febe5
Revises: 
Create Date: 2022-12-13 11:56:11.666336
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('photo_id', sa.Integer(), nullable=True),
    sa.Column('kelas', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['kelas'], ['kelas.id'], ),
    sa.ForeignKeyConstraint(['photo_id'], ['media.id'], ),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['konten_id'], ['konten.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
